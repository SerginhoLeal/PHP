    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form method="post" action="?classe=Usuario&acao=update&id=<?=$usuario->getId()?>">
                    <div class="form-group">
                        <label for="nome">Nome:</label>
                        <input type="nome" class="form-control" id="nome" placeholder="nome"  name="nome" value="<?=$usuario->getNome()?>">
                    </div>
